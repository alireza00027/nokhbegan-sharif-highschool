                    ...
                    <div class="card card-nokhbegan">
                        <div class="border-bottom-0 mx-4 mt-3 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <h3 class="card-title">لیست معلمین</h3>
                            </div>
                            <form action="#">
                            ...
                            <table id="usersList" class="table table-hover text-center" style="border-spacing: 0; border-collapse: separate;">
                                ...
                                @foreach($teachers as $teacher)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('admin.students.delete',['user'=>$teacher->id])}}" method="POST">
                                                {{ csrf_field() }}
                                                {{method_field('delete')}}
                                                <a class="ml-2" href="{{route('admin.students.edit',['user'=>$teacher->id])}}"><i class="fa fa-edit text-dark fs4"></i></a>
