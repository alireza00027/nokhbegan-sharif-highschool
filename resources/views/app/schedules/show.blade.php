                                                            ...
                                                            @foreach ($answerScheduleItems as $key =>$value)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input name="answer_amount_today_lessons_{{$value->day_of_week}}" id="answer_amount_today_lessons" class="form-control  text-center "  value="{{$value->amount_today_lessons}}">
                                                                    </td>
                                                                    <td>
                                                                        ...
                                                                        <input name="answer_amount_tomorow_lessons_{{$value->day_of_week}}" id="answer_amount_tomorow_lessons" class="form-control  text-center "  value="{{$value->amount_tomorow_lessons}}">
                                                                    </td>
                                                                    <td>
                                                                        ...
                                                                        <input name="answer_amount_review_previous_lessons_{{$value->day_of_week}}" id="answer_amount_review_previous_lessons" class="form-control  text-center "  value="{{$value->amount_review_previous_lessons}}">
                                                                    </td>
                                                                    <td>
                                                                        ...
                                                                        <input name="answer_home_work_{{$value->day_of_week}}" id="answer_home_work" class="form-control  text-center " value="{{ $value->home_work}}">
                                                                    </td>
                                                                    <td>
